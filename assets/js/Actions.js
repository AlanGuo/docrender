...
var MooShellActions = new Class({
    ...
    prepareCoffee: function(callback) {
        ...
        }, 'http://jsfiddle.net/js/coffeescript/coffeescript.js', callback, this);
    },
    ...
    prepareTidyUp: function(callback, scope) {
        ...
        }, 'http://jsfiddle.net/js/beautifier.js', callback, scope);
    },
    ...
    jsLint: function(e) {
        ...
        //   Asset.javascript('http://jsfiddle.net/js/jslint.min.js', {
    ...
    makeFavourite: function(e) {
        ...
        new Request.JSON({
            ...
            'data': {
                shell_id: this.options.example_id
            },
    ...
    loadLibraryVersions: function(group_id) {
        if (group_id) {
            new Request.JSON({
                url: this.options.loadLibraryVersionsURL.substitute({
                    group_id: group_id
                }),
                onSuccess: function(response) {
                    $('js_lib').empty();
    ...
    loadDependencies: function(lib_id) {
        if (lib_id) {
            new Request.JSON({
                url: this.options.loadDependenciesURL.substitute({
                    lib_id: lib_id
                }),
                method: 'get',
                onSuccess: function(response) {
